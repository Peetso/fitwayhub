    ...
    <div style={{ padding: "20px 16px 32px", maxWidth: 900, margin: "0 auto" }}>
      ...
      <div className="fade-up" style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 32 }}>
        <div>
          ...
          <h1 style={{ fontFamily: "'Chakra Petch', sans-serif", fontSize: 30, fontWeight: 700, color: "var(--text-primary)", lineHeight: 1.1 }}>
            {firstName}
          </h1>
      ...
      {/* ── Stats ── */}
      <div className="fade-up-1" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(160px, 1fr))", gap: 12, marginBottom: 24 }}>
