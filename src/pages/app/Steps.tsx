  ...
  return (
    <div style={{ padding: "20px 16px 40px", maxWidth: 960, margin: "0 auto" }}>
      ...
      {(() => {
        ...
        return (
          <div style={{ display: "flex", alignItems: "center", gap: 20, marginBottom: 24, padding: "20px", backgroundColor: "var(--bg-card)", border: `1px solid ${goalReached ? 'rgba(200,255,0,0.4)' : 'var(--border)'}`, borderRadius: 16 }}>
